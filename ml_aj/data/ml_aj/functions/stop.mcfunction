...
$execute if score @s ml_aj.temp matches 0 run function ml_aj:system/player/notice/display {text:"Failed to stop the current animation for the model with id $(id).",color:"red",bold:false}
