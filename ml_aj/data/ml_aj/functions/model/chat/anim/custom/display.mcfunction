...
$data modify storage ml_aj:logic data.player.temp set value {id:"$(id)",badge:0,loop:{id:"$(id)",badge:0,index:0}}
...
function ml_aj:model/chat/anim/custom/display_extra with storage ml_aj:logic data.player.temp
