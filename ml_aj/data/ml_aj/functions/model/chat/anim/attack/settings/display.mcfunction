...
$data modify storage ml_aj:logic data.player.temp set value {id:"$(id)",index:$(index),name:"",damage:-1,damage_text:"-1",distance:0f,dist_int:0,dir:"True",full:0,impact:0,impact_text:"First Frame",cooldown:0,command:'(No Callback Set)',suggest:"",cmd_time:"",cmd_entity:"",projectile:"None",proj_speed:{"text":""},proj_nbt:'{}',proj_suggest:"{}",proj_text:{"text":""}}
