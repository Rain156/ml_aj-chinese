...
$execute as @e[distance=..$(distance),sort=nearest,$(selector)] run function ml_aj:system/entity/raycast/no_hitbox_final with storage ml_aj:logic data.temp.raycast
